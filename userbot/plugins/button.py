...
@catub.cat_cmd(
    ...
    info={
        ...
        "examples": "{tr}ibutton test [google]<buttonurl:https://www.google.com> [TeleRoidbot]<buttonurl:https://t.me/TeleRoidGroup:same> [support]<buttonurl:https://t.me/TeleRoid14>",
    },
)
async def _(event):
